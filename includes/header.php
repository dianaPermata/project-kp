    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-3">
          <div class="logo"><a href="index.php"><img src="images/S09-font-black.png" width="120px" height="60px" alt="image"/></a> </div>
        </div>
        <div class="col-sm-8 col-md-8">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <a href="mailto:studio09.madiun@gmail.com">studio09.madiun@gmail.com</a></div>
            <div class="header_widgets">
              <div class="circle_icon"> <i class="fa fa-phone" aria-hidden="true"></i> </div>
              <p class="uppercase_text">Telp : </p>
              <a href="https://wa.me/6283115372269">+62 83115372269</a> </div>
