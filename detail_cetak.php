...
<head>
	...
	<link href="admin/img/anala.jpg" rel="icon" type="images/x-icon">
			...
			<table class="table table-borderless">
				<tbody>
					<tr>
						...
						<td class="text-center"><h3>Anala Studio.com</h3></td>
						<td rowspan="3" width="16%">&nbsp;</td>
					</tr>
					<tr>
						<td class="text-center">Phone : 08532827606 | E-mail : analastudio@gmail.com</td>
					</tr>
					<tr>
						<td class="text-center">Magetan</td>
					</tr>
				</tbody>
			</table>
			<hr class="line-top" />
