  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1>Daftar Paket Fotografi Di Studio 09</h1>
      </div>
      <ul class="coustom-breadcrumb">
        <li><a href="index.php">Home</a></li>
        <li>Daftar Paket Fotografi Di Studio 09</li>
      </ul>
    </div>
  </div>
	...
	<div class="col-list-3">
		<div class="recent-car-list">
			...
			<div class="car-title-m">
				...
				<br>
				<span class="price"><?php echo htmlentities(format_rupiah($results['harga']));?></span> 
			</div>
