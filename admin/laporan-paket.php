...
<body>
	...
	<div class="ts-main-content">
		...
		<div class="content-wrapper">
			...
			<h2 class="page-title">Laporan Paket</h2>
						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Data Paket Booking</div>
                    ...
                    <?php } ?>
							...
							<div class="form-group">
									<a href="laporan-cetak-paket.php" target="_blank" class="btn btn-primary">Cetak</a>
							</div>
