	...
	<div class="ts-main-content">
		...
		<div class="content-wrapper">
			<div class="container-fluid">
						<h2 class="page-title">Laporan Jadwal</h2>
						...
						<?php
							if(isset($_GET['submit'])){
								...
								$stt	 = "Sudah Dibayar";
								$stt1	 = "Selesai";
								$sqlsewa = "SELECT * FROM transaksi WHERE tgl_take BETWEEN '$mulai' AND '$selesai'";
								$querysewa = mysqli_query($koneksidb,$sqlsewa);
							?>
						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Laporan Tanggal Pemotretan <?php echo IndonesiaTgl($mulai);?> sampai <?php echo IndonesiaTgl($selesai);?></div>
							<div class="panel-body">
                    ...
                    $sqlsewa = "SELECT transaksi.*,paket.*,member.* FROM transaksi, paket, member 
                                ...
                                AND tgl_take BETWEEN '$awal' AND '$selesai'
                    ...
                    <?php } ?>
						...
						<div class="form-group">
									<a href="laporan_cetak-jadwal.php?awal=<?php echo $mulai;?>&akhir=<?php echo $selesai;?>" target="_blank" class="btn btn-primary">Cetak</a>
							</div>
						<?php }?>
